...
const Navbar = () => {
  ...
  return (
    <div className="flex text-2xl justify-between text-gray-200 items-center px-6 mx-w-[1300px] mx-auto h-24">
      <a href="">Vishal</a>
      <ul className="hidden md:flex gap-12 z-10 cursor-pointer">
        <li className="relative group">
          <Link to="about" smooth={true} offset={10} duration={4000}>
            About
          </Link>
        ...
        <li className="relative group">
          <Link to="contact" smooth={true} offset={10} duration={4000}>
            Contact
          </Link>
          <span className="absolute bottom-0 left-0 w-full h-1 bg-sky-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-in-out"></span>
        </li>
